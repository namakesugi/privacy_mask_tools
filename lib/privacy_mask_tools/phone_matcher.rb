...
module PrivacyMaskTools::PhoneMatcher
  ...
  # 携帯番号 ハード判定用正規表現
  JARGON_MOBILE_NUMBER_REGEXP = /([(（]?([0０oO〇十]?[7-9７-９⑦⑧⑨七八九][0０oO〇十])[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{4})[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{4})(?![0-9０-９]))/
  ...
  JARGON_PHONE_NUMBER_REGEXP = /([(（]?(([0０oO〇十][3３三参③4４四④6６六⑥])[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{4})|([0０oO〇十][1-9１-９一二三四五六七八九四①-⑨壱弐参]{2})[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{3})|([0０oO〇十][1-9１-９一二三四五六七八九十①-⑨壱弐参]{2}[0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参])[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{2})|([0０oO〇十][1-9１-９一-九四①-⑨壱弐参]{2}[0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{2})[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参])|([0０oO〇十][5５五⑤][0０oO〇十])[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{4}))[-ー()（）・ 　]*([0-9０-９oO①-⑨一二三四五六七八九十〇壱弐参]{4})(?![0-9０-９]))/
